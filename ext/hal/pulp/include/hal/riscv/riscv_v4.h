...
#define hal_spr_read_then_clr(reg,val) \
  ({ \
    int state; \
    __asm__ volatile ("csrrc %0, %1, %2" :  "=r" (state) : "I" (reg), "I" (val) ); \
    state; \
  })
...
({ \
  int result; \
  __asm__ volatile ("csrr %0, %1" : "=r" (result) : "I" (reg) ); \
  result; \
})
...
({                \
  ...
  ____asm____ __volatile__ ("csrr %0, " #csr      \
            : "=r" (__v));      \
  __v;              \
})
...
static inline unsigned int core_id() {
  ...
  __asm__("csrr %0, 0x014" : "=r" (hart_id) : );
#else
  __asm__("csrr %0, 0xF14" : "=r" (hart_id) : );
#endif
#else
  __asm__("csrr %0, 0xF10" : "=r" (hart_id) : );
#endif
...
static inline void cpu_perf_conf_events(unsigned int eventMask)
{
  ...
  __asm__ volatile ("csrw 0x7A0, %0" : "+r" (eventMask));
#endif
}
...
#ifndef PLP_NO_PERF_COUNTERS
  unsigned int result;
  __asm__ volatile ("csrr %0, 0x7A0" : "=r" (result));
  return result;
#else
  return 0;
#endif
...
{
#ifndef PLP_NO_PERF_COUNTERS
  __asm__ volatile ("csrw 0x7A1, %0" :: "r" (confMask));
#endif
}
...
#ifndef PLP_NO_PERF_COUNTERS
  __asm__ volatile ("csrw 0x79F, %0" :: "r" (value));
#endif
}
...
static inline unsigned int cpu_perf_get(const unsigned int counterId) {
  ...
  switch(counterId) {
   case  0: __asm__ volatile ("csrr %0, 0x780" : "=r" (value)); break;
   case  1: __asm__ volatile ("csrr %0, 0x781" : "=r" (value)); break;
   case  2: __asm__ volatile ("csrr %0, 0x782" : "=r" (value)); break;
   case  3: __asm__ volatile ("csrr %0, 0x783" : "=r" (value)); break;
   case  4: __asm__ volatile ("csrr %0, 0x784" : "=r" (value)); break;
   case  5: __asm__ volatile ("csrr %0, 0x785" : "=r" (value)); break;
   case  6: __asm__ volatile ("csrr %0, 0x786" : "=r" (value)); break;
   case  7: __asm__ volatile ("csrr %0, 0x787" : "=r" (value)); break;
   case  8: __asm__ volatile ("csrr %0, 0x788" : "=r" (value)); break;
   case  9: __asm__ volatile ("csrr %0, 0x789" : "=r" (value)); break;
   case 10: __asm__ volatile ("csrr %0, 0x78A" : "=r" (value)); break;
   case 11: __asm__ volatile ("csrr %0, 0x78B" : "=r" (value)); break;
   case 12: __asm__ volatile ("csrr %0, 0x78C" : "=r" (value)); break;
   case 13: __asm__ volatile ("csrr %0, 0x78D" : "=r" (value)); break;
   case 14: __asm__ volatile ("csrr %0, 0x78E" : "=r" (value)); break;
   case 15: __asm__ volatile ("csrr %0, 0x78F" : "=r" (value)); break;
   case 16: __asm__ volatile ("csrr %0, 0x790" : "=r" (value)); break;
   case 17: __asm__ volatile ("csrr %0, 0x791" : "=r" (value)); break;
   case 18: __asm__ volatile ("csrr %0, 0x792" : "=r" (value)); break;
   case 19: __asm__ volatile ("csrr %0, 0x793" : "=r" (value)); break;
   case 20: __asm__ volatile ("csrr %0, 0x794" : "=r" (value)); break;
   case 21: __asm__ volatile ("csrr %0, 0x795" : "=r" (value)); break;
   case 22: __asm__ volatile ("csrr %0, 0x796" : "=r" (value)); break;
   case 23: __asm__ volatile ("csrr %0, 0x797" : "=r" (value)); break;
   case 24: __asm__ volatile ("csrr %0, 0x798" : "=r" (value)); break;
   case 25: __asm__ volatile ("csrr %0, 0x799" : "=r" (value)); break;
   case 26: __asm__ volatile ("csrr %0, 0x79A" : "=r" (value)); break;
   case 27: __asm__ volatile ("csrr %0, 0x79B" : "=r" (value)); break;
   case 28: __asm__ volatile ("csrr %0, 0x79C" : "=r" (value)); break;
   case 29: __asm__ volatile ("csrr %0, 0x79D" : "=r" (value)); break;
   case 30: __asm__ volatile ("csrr %0, 0x79E" : "=r" (value)); break;
  }
  return value;
#else
  return 0;
