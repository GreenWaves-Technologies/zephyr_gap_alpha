...
#ifndef ZEPHYR_INCLUDE_ARCH_RISCV32_GAP_ASM_INLINE_GCC_H_
#define ZEPHYR_INCLUDE_ARCH_RISCV32_GAP_ASM_INLINE_GCC_H_
 ...
 * NOTE: only gap-specific NOT RISCV32
 */
...
/*
 * Account for gap-specific bit manipulation opcodes only when
